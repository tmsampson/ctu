...
tasks to be added, prioritised, listed, sorted, removed and cleared, using a simple and
familiar command line syntax. Task lists are stored in a simple and hand-editable text
